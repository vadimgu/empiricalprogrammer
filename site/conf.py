...
BLOG_AUTHOR = "Vadim Gubergrits"  # (translatable)
...
BLOG_EMAIL = "vadim.gubergrits@gmail.com"
...
#          will nt be generated for that directory.
# PAGE_INDEX = False
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-126375279-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-126375279-1');
</script>
"""
